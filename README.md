...
> **Status: 0.9.0 adopter preview** (not 1.0). Phase 11 Wave A coverage is done. **Phase 12 next:** Packagist / 1.0 cut (+ optional Wave B) — [HANDOFF](docs/HANDOFF-phase-12.md), [coverage map](docs/coverage-rules-skills.md). Composer name: **`chrisshick/cakephp-agent`**.
...
| [Phase 12 handoff](docs/HANDOFF-phase-12.md) | Next agent: Packagist / 1.0 (+ optional Wave B) |
