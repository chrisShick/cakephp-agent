...
| **12 Packagist / 1.0 (+ optional Wave B)** | **Next** — [HANDOFF-phase-12.md](HANDOFF-phase-12.md) |
...
- 1.0 requires Packagist (or equivalent) + Wave A (done) + soak — see [pre-1.0-review.md](pre-1.0-review.md).
